...
final class SystemEventsHandlerTests: XCTestCase {
    ...
    func setupSut(countries: [MockedCountriesInteractor.Action] = [],
        ...
        let interactors = DIContainer.Interactors(
            countriesInteractor: MockedCountriesInteractor(expected: countries) as! CountriesInteractor,
            imagesInteractor: MockedImagesInteractor(expected: []) as! ImagesInteractor,
            userPermissionsInteractor: MockedUserPermissionsInteractor(expected: permissions) as! UserPermissionsInteractor)
        ...
        sut = RealSystemEventsHandler(container: container,
                                      deepLinksHandler: deepLinksHandler as! DeepLinksHandler,
                                      pushNotificationsHandler: pushNotificationsHandler as! PushNotificationsHandler,
                                      pushTokenWebRepository: pushTokenWebRepository as! PushTokenWebRepository)
    }
